...
def main():
    ...
    coleman_index = calculate_col(letters, words, sentences)
...
def calculate_col(letters, words, sentences):
    col_L = letters *100 / words
    col_S = sentences *100 / words
    return round(0.0588 * col_L - 0.296 * col_S - 15.8)
